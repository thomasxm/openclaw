...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "messages.toolProgress": "Tool Progress Messages",
  "messages.toolProgress.enabled": "Enable Tool Progress",
  "messages.toolProgress.throttleMs": "Tool Progress Throttle (ms)",
  "messages.toolProgress.maxVisibleTools": "Max Visible Completed Tools",
